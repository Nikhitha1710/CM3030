...
public class PlayerCarController : MonoBehaviour
{
    ...
    private void MoveCar()
    {
        ...
        if (GetComponent<Rigidbody>().linearVelocity.magnitude > maxSpeed)
        {
            GetComponent<Rigidbody>().linearVelocity = GetComponent<Rigidbody>().linearVelocity.normalized * maxSpeed;
        }
    }
